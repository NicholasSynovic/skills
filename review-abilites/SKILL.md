...
*cross-cutting* qualities that decide whether a project survives contact with
...
1. **Accessibility** — code *approachability*: how easily someone can discover,
...
1. **Establish scope.** Identify exactly what you were asked to review — whole
   ...
   - Always look just far enough *outside* the scope to judge **cohesion** and
...
2. **Evaluate each ability deliberately.** Go through all eight — don't stop at
   ...
   rubric anchors in mind), a `path:line` reference where applicable, *why it
