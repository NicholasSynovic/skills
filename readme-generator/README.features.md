...
- **Deterministic screenshot generation from Storybook** (Playwright + Sharp, WebP, Chromatic-triggered) — *asset maintenance, edge case*
...
- **Keyword optimization / CTR** (short-description char limits, caption SEO) — *WordPress, edge case*
...
- **Multi-format output** (Plain text / Markdown / RST for PyPI) — *partially in scope*
...
- **readme-com** — integrates with the **readme.com documentation-hosting SaaS**
  (Projects/Docs/Categories via Membrane CLI), *not* `README.md` files. Fully
